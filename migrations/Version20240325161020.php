 ...
 */
final class Version20240325161020 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO user (id, full_name, pseudo, email, roles, password, created_at) SELECT id, full_name, pseudo, email, roles, password, created_at FROM __temp__user');
